...
export default function Home() {
  return (
    <div className="min-h-screen flex items-center justify-center">
      {/* Main hero card for the home page. */}
      ...
      backdrop-blur-xl bg-black/80">
        ...
        {/* Top status row with location and availability. */}
        ...
        <div>
          <h1 className="text-4xl"> James Bisiriyu</h1>
          <h3 className="text-xl font-bold mt-2 bg-clip-text
          text-transparent bg-gradient-to-r from-emerald-400
          via-sky-300 to-blue-500">Web Developer</h3>
          {/* Short intro paragraph with a contact link. */}
          <p className="text-pretty tracking-tight mt-3
          text-neutral-300">Hello, it&apos;s James. I am a Junior Web Developer with 2 years of experience, 
          currently working on my own projects. { " " }
<Link href="/contact" className="bg-clip-text
  text-transparent bg-gradient-to-r from-emerald-400
  via-sky-300 to-blue-500 font-bold opacity-90 hover:opacity-100
  transition-opacity"> Contact Me{"  "}</Link>
        ...
        <nav className="space-y-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            border-gray-700/40 flex group
            items-center justify-between p-3
            cursor-pointer transition-colors duration-200
            ease-linear hover:bg-zinc-800/40 rounded-lg">
              <span>About</span>
